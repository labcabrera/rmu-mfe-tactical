...
const ActionResolutionActions = ({ game: game, character, formData, isValid = true }) => {
    ...
    <div className="generic-action-bar">
      ...
      >
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography sx={{ color: 'text.primary' }}>{t(formData.type)} resolution</Typography>
        </Breadcrumbs>

        <div style={{ flexGrow: 1 }} />

        <BackButton onClick={handleBackClick} size={80} />
        <SaveButton onClick={createAction} size={80} disabled={!isValid} />
      </Stack>
    </div>
  );
};

export default ActionResolutionActions;
