...
import SelectAttackMode from '../../shared/selects/SelectAttackMode';
import SelectDefender from '../../shared/selects/SelectDefender';
...
const AttackDeclarationAttributes = ({ formData, setFormData, character, characters }) => {
  ...
  const handleRestrictedQuarterChange = (e) => {
    updateFormData('attackInfo', 'restrictedQuarters', e);
  };
  const handleChargeSpeedChange = (e) => {
    updateFormData('attackInfo', 'chargeSpeed', e);
  };
  const handleParryChange = (e) => {
    updateFormData('attackInfo', 'parry', parseInt(e.target.value));
  };
    ...
    <>
      <div className="generic-main-content">
        ...
        <Grid container spacing={2}>
          ...
          <Grid item size={6}>
            <Typography>Actions points penalty: {actionPointsPenalty}</Typography>
          </Grid>
